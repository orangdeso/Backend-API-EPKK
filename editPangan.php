...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $user_id = $_POST['id_pokja3_bidang1'];
    $tanggal = date('Y-m-d');
    ...
    try {
        $query = "UPDATE laporan_pangan SET beras = '$beras', non_beras = '$non_beras', 
                    peternakan = '$peternakan', perikanan = '$perikanan', warung_hidup = '$warung_hidup', 
                    lumbung_hidup = '$lumbung_hidup', toga = '$toga', tanaman_keras = '$tanaman_keras', 
                    catatan = '', status = 'Proses', updated_at = '$created_at'
                    WHERE id_pokja3_bidang1 = '$user_id'";
